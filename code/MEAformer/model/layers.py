...
class MultiHeadGraphAttention(nn.Module):
    ...
    def get_relation2imp(self, triples, relation_num):
        """
    ...
    def init_triple_coefficient(self):
        self.relation2imp_sr = self.get_relation2imp(self.triples_sr, len(self.id2relation_sr))
        self.relation2imp_tg = self.get_relation2imp(self.triples_tg, len(self.id2relation_tg))
